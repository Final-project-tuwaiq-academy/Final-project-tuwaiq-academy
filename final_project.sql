...
--
-- Table structure for table `post_price`
--

CREATE TABLE `post_price` (
  `post_price_id` int(11) NOT NULL,
  `post_id` int(11) NOT NULL,
  `user_id` int(11) NOT NULL,
...
--
-- Indexes for table `post_price`
--
ALTER TABLE `post_price`
  ADD PRIMARY KEY (`post_price_id`),
...
--
-- Constraints for table `post_price`
--
ALTER TABLE `post_price`
  ADD CONSTRAINT `post_price_ibfk_1` FOREIGN KEY (`post_id`) REFERENCES `posts` (`post_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `post_price_ibfk_2` FOREIGN KEY (`user_id`) REFERENCES `users` (`user_id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
